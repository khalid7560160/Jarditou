...
    {
        document.getElementById("erreurName").textContent = "Merci d'indiquez votre nom";
...
    {
        document.getElementById("erreurPrenom").textContent = "Merci d'indiquer votre prénom ";
...
    {
        document.getElementById("erreurSexe").textContent = "Veuillez selectionner une réponse svp";
...
    if (!birth.test(date))
    {
        document.getElementById("erreurDate").textContent = "Date de naissance incorrect";
        document.getElementById("erreurDate").style.color = 'red';
        event.preventDefault();
    }
    else
    {
        document.getElementById("erreurDate").textContent = "Merci d'indiquer une adresse valide!";
        document.getElementById("erreurDate").style.color = 'green';
    }

    if (!cp.test(codepostal))
    {
        document.getElementById("erreurCP").textContent = "Merci d'indiquez un code postal valide";
...
    if (!adr.test(adresse)) {
        document.getElementById("erreurAdr").textContent = "Merci d'indiquez une adresse valide.";
...
        document.getElementById("erreurVille").textContent = "Merci d'indiquer votre ville.";
...
    }
    if (!mail.test(email)) {
        document.getElementById("erreurMail").textContent = "Email incorrect.";
...
    if (sujet == 1)
    {
        document.getElementById("erreurSujet").textContent = "Merci de selectionner un sujet.";
...
    }
    if (accept != true) {
        document.getElementById("erreurAccept").textContent = "Veuillez cocher cette case svp.";
...
    }
    if (question == "") {
        document.getElementById("erreurQuest").textContent = "Merci de compléter ce champs.";
